...
public class VicFormation extends Formation{
	private Point2D[] vicFormation = {new Point2D(100,0),new Point2D(0,100),new Point2D(50,150),new Point2D(50,50),new Point2D(100,200)};
	MainGame mainGame;
	Enemies en;
	Random random = new Random();
	
	/**
	 * Vic formation of attack.
	 ...
	 */
	public VicFormation(MainGame game, Enemies en){
		mainGame = game;
		this.en = en;
	}
