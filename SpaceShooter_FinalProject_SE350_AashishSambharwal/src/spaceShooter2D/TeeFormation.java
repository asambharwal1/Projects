...
public class TeeFormation extends Formation{
	private Point2D[] TFormation = {new Point2D(0,100),new Point2D(50,50),new Point2D(100,0),new Point2D(50,150), new Point2D(100,200)};
	MainGame mainGame;
	Enemies en;
	Random random = new Random();
	
	/**
	 * Tee formation of attack.
	 ...
	 */
	public TeeFormation(MainGame game, Enemies en){
		mainGame = game;
		this.en = en;
	}
